...
INSERT INTO "user" (active, first_name, last_name,  password, username) VALUES (true, 'Olga', 'Kurilenko', 'WRqqRQMsoy', 'Olga.Kurilenko'), (true, 'Kim','Johnson', '555555', 'Kim.Johnson'), (true, 'Tomas','Kuk', '12345', 'Tomas.Kuk'), (true, 'George','TheThird', '54321', 'George.TheThird'), (true, 'Monica', 'Dobs', '55555', 'Monica.Dobs'), (true, 'Wallace', 'Tim', '66666', 'Wallace.Tim'), (true, 'Tom','Robins', '77777', 'Tom.Robins'), (true, 'Bob','Getty', '88888', 'Bob.Getty');
